...
for items in dirList:
	...
	if(os.path.isdir(geneDirName)):
		...
		altoutFileName = dirName+geneName+"/"+geneName+"_"+groupName+"_branch_alt.out"
		altScriptName = dirName+geneName+"_"+groupName+"_branch_alt_runcod.sh"
		codeml_branches_runner(dirName,seqFileName,treeFileName,altoutFileName,altScriptName,geneName,groupName)
